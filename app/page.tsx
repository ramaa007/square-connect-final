  ...
  return (
    <div ref={containerRef} style={{ backgroundColor: '#ffffff', color: charcoal, fontFamily: 'sans-serif', margin: 0, padding: 0 }}>
      ...
      <section style={{ padding: '120px 24px', maxWidth: '1200px', margin: '0 auto', display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(300px, 1fr))', gap: '80px', alignItems: 'center' }}>
        ...
        <div style={{ backgroundColor: appleGrey, borderRadius: '40px', height: '400px', overflow: 'hidden' }}>
      ...
      {/* 3. STATS */}
      <section style={{ margin: '0 16px', padding: '100px 24px', backgroundColor: charcoal, color: 'white', borderRadius: '64px' }}>
        <div style={{ maxWidth: '1200px', margin: '0 auto', display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(200px, 1fr))', gap: '48px', textAlign: 'center' }}>
          <div><h2 style={{ fontSize: '4.5rem', fontWeight: 'bold', color: gold, margin: 0 }}>5+</h2><p style={{ letterSpacing: '0.2em', fontSize: '10px', opacity: 0.5, marginTop: '8px' }}>YEARS OF EXCELLENCE</p></div>
          <div><h2 style={{ fontSize: '4.5rem', fontWeight: 'bold', color: gold, margin: 0 }}>12+</h2><p style={{ letterSpacing: '0.2em', fontSize: '10px', opacity: 0.5, marginTop: '8px' }}>INDUSTRIES SERVED</p></div>
          <div><h2 style={{ fontSize: '4.5rem', fontWeight: 'bold', color: gold, margin: 0 }}>1</h2><p style={{ letterSpacing: '0.2em', fontSize: '10px', opacity: 0.5, marginTop: '8px' }}>UNIFIED PARTNER</p></div>
        </div>
      </section>

      {/* 4. VALUES TICKER */}
      <div style={{ padding: '60px 0', overflow: 'hidden', borderBottom: '1px solid #eee' }}>
        <div style={{ fontSize: '1.5rem', fontWeight: '900', textTransform: 'uppercase', opacity: 0.15, display: 'flex', gap: '40px', whiteSpace: 'nowrap' }}>
      ...
      {/* 5. ABOUT PREVIEW */}
      <section style={{ padding: '120px 24px', backgroundColor: appleGrey }}>
        <div style={{ maxWidth: '1200px', margin: '0 auto', display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(300px, 1fr))', gap: '60px' }}>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '20px' }}>
            {["Proactive", "Responsive", "Data-Driven", "Accountable"].map(v => (
              <div key={v} style={{ backgroundColor: 'white', padding: '30px', borderRadius: '24px', fontWeight: 'bold', display: 'flex', alignItems: 'center', gap: '12px', boxShadow: '0 4px 6px rgba(0,0,0,0.02)' }}>
                <CheckCircle2 style={{ color: gold }} /> {v}
              </div>
            ))}
          </div>
        </div>
      ...
      {/* 7. WHY CHOOSE US */}
      <section style={{ margin: '0 16px', padding: '120px 24px', backgroundColor: charcoal, color: 'white', borderRadius: '64px', textAlign: 'center' }}>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(200px, 1fr))', gap: '24px' }}>
          {["Vetted Excellence", "Proactive Speed", "Long-term Vision", "Integrated Logic"].map(w => (
            <div key={w} style={{ padding: '40px', border: '1px solid rgba(255,255,255,0.1)', borderRadius: '32px' }}>
              <Star style={{ color: gold, marginBottom: '16px', margin: '0 auto' }} />
              <p style={{ fontWeight: 'bold', marginTop: '12px' }}>{w}</p>
            </div>
          ))}
        </div>
      </section>
      ...
      <section style={{ padding: '120px 24px', maxWidth: '1200px', margin: '0 auto' }}>
        <div style={{ display: 'flex', flexWrap: 'wrap', gap: '80px', alignItems: 'center', backgroundColor: appleGrey, padding: '60px', borderRadius: '64px' }}>
          ...
          <div style={{ flex: 1 }}>
            <p style={{ color: gold, fontWeight: 'bold', letterSpacing: '0.2em', fontSize: '12px' }}>LEAD ADVISOR</p>
      ...
      <section style={{ padding: '120px 0', backgroundColor: '#fff', overflow: 'hidden' }}>
        <div style={{ display: 'flex', gap: '32px', paddingLeft: '24px' }}>
          {[
            ...
            <div key={i} style={{ minWidth: '400px', padding: '60px', backgroundColor: appleGrey, borderRadius: '40px' }}>
              <p style={{ fontSize: '1.2rem', fontStyle: 'italic', marginBottom: '24px' }}>“{rev.t}”</p>
              <p style={{ fontWeight: 'bold', color: gold }}>— {rev.n}</p>
            </div>
          ))}
        </div>
      </section>
      ...
      {/* 11. CTA / FOOTER */}
      <footer style={{ padding: '120px 24px', backgroundColor: appleGrey, borderRadius: '64px 64px 0 0', textAlign: 'center' }}>
